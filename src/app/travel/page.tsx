...
import { ChevronRight, Calendar, Clock, MapPin, Globe2 } from "lucide-react";
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            {upcomingTrips.length > 0 && (
                <div className="mb-12">
                    <h2 className="text-2xl font-semibold tracking-tight mb-6">Upcoming Adventures</h2>
                    <div className="grid gap-6">
                        {upcomingTrips.map((itinerary) => (
                            <Card key={itinerary.id} className="transition-colors hover:bg-muted/50 border-primary/20">
                                <CardHeader>
