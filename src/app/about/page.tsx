...
export const metadata: Metadata = {
    ...
    description: "Learn more about Michael DeMarco, a software engineer based in San Francisco.",
};
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="prose prose-gray dark:prose-invert max-w-none">
                <h1 className="text-4xl font-bold mb-8">A little about me...</h1>

                <Card className="mb-8">
                    <CardContent className="p-6 space-y-4">
                        <p>
                            Hey there! I&apos;m Michael, an Honours Computer Science graduate from{" "}
                            <a href="https://ubc.ca" target="_blank" rel="noreferrer" className="text-primary hover:underline">
                        ...
                        <p>
                            ...
                            <a href="https://curo46.com" target="_blank" rel="noreferrer" className="text-primary hover:underline">
                                General Genomics
                            </a>
                            ,{" "}
                            <a
                        ...
                        <p>
                            ...
                            projects, design, and travel experiences.
                        </p>
                ...
                <div className="grid gap-8 place-items-center">
                    <div className="space-y-2 text-center">
                        <Image
                            ...
                            priority
                        />
                        <p className="text-sm text-muted-foreground">My face! (July 2024)</p>
                    </div>
                    ...
                    <div className="space-y-2 text-center">
                        <Image
                            ...
                            className="rounded-lg"
                        />
                        <p className="text-sm text-muted-foreground">My pet tortoise Leo! (Jun 2020)</p>
                    </div>
                </div>
            </div>
        </div>
