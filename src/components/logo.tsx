...
const Logo = ({ className = '' }) => {
  return (
    <svg
      ...
      className={`fill-black transition-colors duration-200 dark:fill-white ${className}`}
      aria-hidden="true"
    >
      <rect x="509.3" y="354.3" width="51.8" height="236.3" />
      <path
        d="M560.8,560.7v294.6c-0.1,62.2-12.4,102.7-47,132c-31.6,26-83.5,36.7-121.6,36.7l-7.3-46.1c32.4-2,60.8-9.4,77.8-24.7
      ...
      <path
        d="M977.8,909.5c29.4,0,47-21,46.1-45.5c0-26.1-17.6-46.3-44.5-46.3c-27.7,0-47,20.2-47,46.3
        C932.5,888.5,950.2,909.5,977.8,909.5z"
      />
      <path
        d="M879.6,800.5V309.9h-75.8v242.4h-1.7c-19-32.7-62.1-62.1-125.9-62.1c-74.7,0-141,44.8-170.6,122c-2.4,6.4-4.6,13-6.6,19.7
      ...
      />
      <path
        d="M3.2,384c0-42-0.8-76.4-3.2-109.9h62.2l3.2,65.4h2.4c21.8-38.6,58.1-74.6,122.7-74.6c53.3,0,93.6,33.5,110.6,81.3h1.6
