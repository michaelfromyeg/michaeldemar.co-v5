...
import { notion, n2m, isFullPage, getRichTextContent, normalizeContent, processImages, downloadAndSaveImage } from './index';
...
export function parseNotionPageToDesignProject(page: DatabaseObjectResponse): Omit<DesignProject, 'images'> {
    if (!isFullPage(page)) {
